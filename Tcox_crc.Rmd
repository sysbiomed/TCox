...
# 2. Download and prepare dataframes
## 2.1 Tumoral samples RTCGAtoolbox
...
## using both normal and tumor from TCGA
...
## 3.1 Analyse different weight vectores:
...
## 3.2 Demosntrative train and test survival curves - Figure 3 
